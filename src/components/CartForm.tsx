    ...
    <form onSubmit={handleSubmit} className="flex flex-wrap gap-4">
      ...
      <div className="flex items-end">
        <button
          type="submit"
          disabled={loading}
          className="px-6 py-2 bg-wallbit-blue text-white rounded-md hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-wallbit-blue focus:ring-offset-2 focus:ring-offset-wallbit-card disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
        >
          {loading ? (
            <>
